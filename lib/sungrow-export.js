...
module.exports = require("sungrow-components/lib/sungrow-footer");
  ...
  return _c(
    ...
    [
      _c(
        ...
        [_vm._v(_vm._s(_vm.text) + "111")]
      ),
      _c("SungrowFooter", [_vm._v("111")])
    ],
    1
  )
}
...
// EXTERNAL MODULE: external "sungrow-components/lib/sungrow-footer"
var sungrow_footer_ = __webpack_require__(1);
var sungrow_footer_default = /*#__PURE__*/__webpack_require__.n(sungrow_footer_);
...
/* harmony default export */ var sungrow_exportvue_type_script_lang_js_ = ({
  name: 'sungrow-export',
  components: {
    SungrowFooter: sungrow_footer_default.a
  },
  props: {
    loading: {
      type: Boolean,
  ...
  methods: {
    exportFile() {
      Promise.all(/* require.ensure */[__webpack_require__.e(2), __webpack_require__.e(3)]).then((async () => {
        const {
...
/* harmony default export */ var packages_sungrow_export = __webpack_exports__["default"] = (sungrow_export);
