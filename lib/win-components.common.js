...
module.exports = require("@winning-plugin/win-6.0-httpclient");
...
// EXTERNAL MODULE: external "@winning-plugin/win-6.0-httpclient"
var win_6_0_httpclient_ = __webpack_require__(1);
var win_6_0_httpclient_default = /*#__PURE__*/__webpack_require__.n(win_6_0_httpclient_);
...
const httpClient = new win_6_0_httpclient_default.a({
  failAuth: () => {
    console.log('接口请求失败');
  },
  errorHandle: msg => {
...
var querySetting_component = normalizeComponent(
...
var win_encounter_filter_component = normalizeComponent(
...
/* harmony default export */ var encounterFilter = (win_encounter_filter);
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./packages/footer/src/win-footer.vue?vue&type=template&id=2a0fd197&
var win_footervue_type_template_id_2a0fd197_render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("footer", { staticClass: "win-footer-wrapper" }, [
    _c("div", { staticClass: "win-footer-wrapper__copyright" }, [
      _c("span", { staticClass: "win-footer-wrapper__copyright__symbol" }, [
        _vm._v("©️")
      ]),
...
var win_footervue_type_template_id_2a0fd197_staticRenderFns = []
win_footervue_type_template_id_2a0fd197_render._withStripped = true


// CONCATENATED MODULE: ./packages/footer/src/win-footer.vue?vue&type=template&id=2a0fd197&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib??vue-loader-options!./packages/footer/src/win-footer.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ var win_footervue_type_script_lang_js_ = ({
  name: 'win-footer',
  props: {
    copyrightText: {
      type: String,
      default: '2020 Winning Health 版权所有'
    }
  }
});
// CONCATENATED MODULE: ./packages/footer/src/win-footer.vue?vue&type=script&lang=js&
 /* harmony default export */ var src_win_footervue_type_script_lang_js_ = (win_footervue_type_script_lang_js_); 
// CONCATENATED MODULE: ./packages/footer/src/win-footer.vue
...
var win_footer_component = normalizeComponent(
  src_win_footervue_type_script_lang_js_,
  win_footervue_type_template_id_2a0fd197_render,
  win_footervue_type_template_id_2a0fd197_staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var win_footer_api; }
win_footer_component.options.__file = "packages/footer/src/win-footer.vue"
/* harmony default export */ var win_footer = (win_footer_component.exports);
// CONCATENATED MODULE: ./packages/footer/index.js


win_footer.install = function (Vue) {
  Vue.component(win_footer.name, win_footer);
};

/* harmony default export */ var footer = (win_footer);
// CONCATENATED MODULE: ./src/index.js
/* Automatically generated by './build/bin/build-entry.js' */


const components = [encounterFilter, footer];
